        ...
        children: [
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/start3.png"),
              fit: BoxFit.contain)
            ),
          ),
          Positioned(
                ...
                child: Column(
                  children: [
                    ...
                    const Row(
                      ...
                      children: [
                        Text("Start discover your ",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 23),)
                      ],
                    ),
                    const Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("unique fashion ",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 23,color: Color.fromARGB(255, 98, 158, 130)),),
                        Text("style ",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 23,),)
                      ],
                    ),
