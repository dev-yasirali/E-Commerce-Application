...
import 'package:ecommerece_app/start3.dart';
        ...
        children: [
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/start2.png"),
              fit: BoxFit.contain)
            ),
          ),
          Positioned(
                ...
                child: Column(
                  children: [
                    ...
                    const Row(
                      ...
                      children: [
                        Text("Define yourself in ",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 23),)
                      ],
                    ),
                    const Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("your ",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 23),),
                        Text("unique way ",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 23,color: Color.fromARGB(255, 98, 158, 130)),)
                      ],
                    ),
                    ...
                    ElevatedButton(
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder:(context)=>const Start3()));
                      },
